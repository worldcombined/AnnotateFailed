...
import com.springapp.sectest.repository.implement.UserRepository;
import com.springapp.sectest.service.UserAccessDetails;
...
@ComponentScan(basePackageClasses={UserRepository.class, UserAccessDetails.class})
